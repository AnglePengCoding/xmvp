package com.github.anglepengcoding.mvp.utils.permission;
...
public final class PermissionUtils {
    ...
    private static boolean isGranted(final String permission) {
        return PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(Utils.getApp(), permission);
    }
