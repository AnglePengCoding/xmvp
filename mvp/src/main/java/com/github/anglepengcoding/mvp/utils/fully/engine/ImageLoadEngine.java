 ...
 */
public class ImageLoadEngine implements ImageEngine {
    /**
     * 加载图片
     *
     * @param context   上下文
    ...
    public ImageLoadEngine() {
    }

    private static ImageLoadEngine instance;

    public static ImageLoadEngine createGlideEngine() {
        if (null == instance) {
